...
\frametitle{Types of Users}
   \begin{picture}(320,250)  %must be related to where it is centered
    \visible<4>{\put(30, 145){\includegraphics[height=1.5in]{images/xkcd-incident.png}}}
...
\frametitle{The ``Shell"}
   \begin{picture}(320,250)  %must be related to where it is centered
    \visible<1-3>{\put(165, 80){\includegraphics[height=2.2in]{images/linux-shell-small.jpg}}}
    \put(-20, 220){\begin{minipage}[t]{0.6 \linewidth}
    {
    \begin{itemize}
...
\begin{itemize}
    ...
    \item \code{mv $\sim$/file2.txt $\sim$/newdir/}
\end{itemize}
\end{frame}
...
\begin{itemize}
    ...
    \item \chref{https://xkcd.com/838/}{XKCD - Incident by Randall Munroe - Creative Commons}
\end{itemize}
\end{frame}
